...
hipoPI = controlador(0.000103333,41686938.2080771,syshipo)
...
clr2 = np.array([217,22,86])/255
clr6 = np.array([247,82,112])/255
clr3 = np.array([ 203,4,4])/255
clr4 = np.array([ 125,150,117])/255


fg2 = plt.figure()
plt.plot(t,Pp0,'-',linewidth=1,color=clr1,label='Pp(t):Normotenso')
plt.plot(t,Pp1,'-',linewidth=1,color=clr3,label='Pp(t):Hipotenso')
plt.plot(t,Pp3,':',linewidth=1,color=clr4,label='Pp(t):Hipertenso PI')
plt.grid(False)
plt.xlim(0,10); plt.xticks(np.arange(0,11,1))
plt.ylim(-0.6,1.4); plt.yticks(np.arange(-0.6,1.6,0.2))
plt.xlabel('Pp(t)[V]')
...
plt.plot(t,Pp0,':',linewidth=1,color=clr1,label='Pp(t):Normotenso')
plt.plot(t,Pp1,':',linewidth=1,color=clr3,label='Pp(t):Hipotenso')
plt.plot(t,Pp4,':',linewidth=1,color=clr4,label='Pp(t):Hipertenso PI')
plt.grid(False)
plt.xlim(0,10); plt.xticks(np.arange(0,11,1))
plt.ylim(-0.6,1.4); plt.yticks(np.arange(-0.6,1.6,0.2))
plt.xlabel('Pp(t)[V]')
